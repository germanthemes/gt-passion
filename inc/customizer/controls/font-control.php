...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 */
	class GT_Passion_Customize_Font_Control extends WP_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'gt_passion_custom_font';
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'gt-passion' ),
				'next'     => esc_html__( 'Next Font', 'gt-passion' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'gt-passion' ),
			);

			// Set Fonts.
			$this->fonts = GT_Passion_Custom_Fonts::get_available_fonts();
