...
function gt_passion_customize_preview_js() {
	wp_enqueue_script( 'gt-passion-customize-preview', get_template_directory_uri() . '/assets/js/customize-preview.js', array( 'customize-preview' ), '20190713', true );
}
...
function gt_passion_customizer_controls_js() {
	wp_enqueue_script( 'gt-passion-customizer-controls', get_template_directory_uri() . '/assets/js/customizer-controls.js', array(), '20190713', true );
}
...
function gt_passion_customizer_controls_css() {
	wp_enqueue_style( 'gt-passion-customizer-controls', get_template_directory_uri() . '/assets/css/customizer-controls.css', array(), '20190713' );
}
