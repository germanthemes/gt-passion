...
class GT_Passion_Custom_Fonts {
	...
	static function remove_default_theme_fonts() {
		...
		// Remove default Fira Sans font if not needed or GT Local Font plugin already loads it.
		if ( ( ! in_array( 'Fira Sans', $selected_fonts ) && ! is_customize_preview() ) or class_exists( 'GermanThemes_Local_Fonts' ) ) {
			wp_dequeue_style( 'gt-passion-theme-fonts' );
		}
	}
	...
	static function get_available_fonts() {
		...
		$fonts = array(
			...
			'Fira Sans'                   => 'Fira Sans', // default font from /assets/css/theme-fonts.css
